...
/**
 * `lock` — smart lock. `locked` is the reported lock state; a device that reports no stable state param
 * carries its transitions on the `lockState` event instead, whose payload names the decoded `locked`.
 */
