 ...
 * custom1→home→custom1. Weaker evidence than a byte-exact capture, and recorded as such: the station
 * confirming the mode it landed in is what distinguishes this from a fire-and-forget write.
