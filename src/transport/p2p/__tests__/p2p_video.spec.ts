...
function wrapEnvelope(mediaKey: Buffer, cameraPubUncompressed: Buffer): Buffer {
...
function sealBody(mediaKey: Buffer, h264: Buffer): { nonce: Buffer; tag: Buffer; ct: Buffer } {
