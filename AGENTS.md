...
The rules for writing code in this repository. They apply to everyone — this file is named `AGENTS.md`
because AI coding tools load it automatically, and an agent that hasn't read them will produce
plausible-looking wrong output. `CODING_STANDARDS.md` is the same file.
